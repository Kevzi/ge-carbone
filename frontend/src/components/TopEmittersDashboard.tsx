                        ...
                        <tr className="border-b-2 border-gray-200 text-left">
                            ...
                            <th className="py-3 px-2">
                                <div className="flex items-center gap-1">
                                    ...
                                    <Tooltip position="bottom" content="Pour les énergies (Scope 1 & 2), le calcul basé sur l'euro dépensé est trop imprécis. Vous devez saisir la quantité réelle consommée (ex: Litres de carburant, kWh d'électricité) visible sur vos factures.">

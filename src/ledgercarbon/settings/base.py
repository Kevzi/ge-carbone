"""
Django base settings for LedgerCarbon project.
"""
...
TENANT_MODEL = "core.Cabinet"
TENANT_DOMAIN_MODEL = "core.Domain"

MIDDLEWARE = [
    'apps.core.middleware.JWTTenantMiddleware',
...
DATABASES = {
    'default': {
        ...
        'NAME': os.getenv('DB_NAME', 'ledgercarbon'),
        'USER': os.getenv('DB_USER', 'ledgercarbon'),
...
CSRF_TRUSTED_ORIGINS = [
    'https://ledgercarbon.org',
    'https://www.ledgercarbon.org',
    'http://localhost:3000',
    'http://127.0.0.1:3000',
]
if _env_csrf:
    CSRF_TRUSTED_ORIGINS.extend([x.strip() for x in _env_csrf.split(',') if x.strip()])
...
# AWS S3 (for FEC file storage)
AWS_ACCESS_KEY_ID = os.getenv('AWS_ACCESS_KEY_ID', '')
AWS_SECRET_ACCESS_KEY = os.getenv('AWS_SECRET_ACCESS_KEY', '')
AWS_STORAGE_BUCKET_NAME = os.getenv('AWS_STORAGE_BUCKET_NAME', 'ledgercarbon-fec')
